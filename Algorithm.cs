...
namespace Putter_Fitting        //changed relativeImportance to public static, changed find arr val to private, added const int heap size
{
    /*public struct node
    {
    ...
    public class Algorithm
	    {
            ...
            public string[] FindPutter()//node[] original idea to return heap, not necessary by calling the putterdata class
            {
                ...
                if(_data[4] == "Struggles with Alignment")
                {
                    ...
                    temp.putterTrait = "Larger Putter Head";
            ...
            PutterData putter = new PutterData(heap, last);
            putter.FindPutter();
